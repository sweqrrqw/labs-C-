...
namespace lab3._2
{
    ...
    class Triangle:Figure
    {
        ...
        public Triangle():base()
        {
            ...
            {
                points[i] = new Point();
                points[i].CoordPointX = random.Next(1, 17);
                points[i].CoordPointY = random.Next(1, 15);
            }
        }
    ...
    {
        // public static bool operator < (Triangle A,Square test1)
        // {
        //     return true;
        // }
        // public static bool operator > (Triangle test,Square test1)
        // {
        //     return true;
        // }
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("5. Сравнить значения периметра фигуры  ");
